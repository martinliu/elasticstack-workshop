...
SSH 登陆虚拟机 2，执行下面的命令，安装 Logstash 所需要的 JDK。
...
在虚拟机 1 上，使用 Elasticserach 的选择的 yum 安装源服务器，执行如下安装命令：
...
ssh 登陆到虚拟机 2，安装 Metricbeat 采集这个服务器上的性能指标。
